...
Mesh::Mesh(Vertex *vertexArray, int  vertexArrayCount, int *indexArray, int  indexArrayCount, ID3D11Device*  device)
{

	CreateBuffer(vertexArray, vertexArrayCount, indexArray, indexArrayCount, device);
...
void Mesh::CreateBuffer(Vertex *vertexArray, int  vertexArrayCount,  int *indexArray, int  indexArrayCount, ID3D11Device*  device)
{	
	...
	ibd.ByteWidth = sizeof(int) * indexArrayCount;    
